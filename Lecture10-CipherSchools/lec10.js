...
let person3 = new person("Daisy", "Chowdhury");
let person2 = new person("Sonu", "Chowdhury");
...
let person5 = new Person("Daisy", 24);
person1.addAddress("Sambalpur");
person1.getDetails();
...
let person6 = new Person("Daisy", "Sonu");
...
let person1 = new Person("Daisy", "Sonu");

console.log(perosn1.firstName);
console.log(person1.getDetails_NoAccess());

let studemt1 = new Student("Sonu", "Chowdhury", 20);
